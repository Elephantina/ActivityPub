 ...
 */
export class Object extends Base<ObjectFields> {
	static create(fields: ObjectFields) {
		return Base._create<ObjectFields>({
...
export type _ObjectFields = WithContext & {
	 ...
	 * The value of source is itself an object which uses its own content and mediaType fields to supply source
	 * information.
	 *
